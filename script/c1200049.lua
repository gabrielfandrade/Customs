...
function s.matfilter2(c,fc,sumtype,tp)
	return c:IsSetCard(0x31,fc,sumtype,tp) and c:IsLevelAbove(5)
end
...
function s.tgfilter(c)
	return c:IsSetCard(0x31) and c:IsAbleToGrave()
end
	--Activation legality
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	--Special summon 1 of your banished "Fortune Lady" monsters
