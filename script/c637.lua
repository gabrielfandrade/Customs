--Simorgh, Bird of Darkness
local s,id=GetID()
function s.initial_effect(c)
	--synchro summon
	Synchro.AddProcedure(c,s.tfilter,1,1,Synchro.NonTuner(Card.IsRace,RACE_WINGEDBEAST),1,99)
	c:EnableReviveLimit()
	--spsummon condition
...
function s.splimit(e,se,sp,st)
	...
	return (st&SUMMON_TYPE_SYNCHRO)==SUMMON_TYPE_SYNCHRO or sc:IsSetCard(0x4602)
end
function s.filter(c)
	return c:IsFacedown()
end
