...
function s.matfilter2(c,fc,sumtype,tp)
	return c:IsSetCard(0x31,fc,sumtype,tp) and c:IsLevelAbove(3)
end
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return ft>-1 and Duel.IsExistingTarget(s.tgfilter,tp,LOCATION_REMOVED,0,1,nil,ft)
		and Duel.IsExistingTarget(s.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g1=Duel.SelectTarget(tp,s.tgfilter,tp,LOCATION_REMOVED,0,1,1,nil,ft)
