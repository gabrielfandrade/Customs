...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_ONFIELD) and s.spfilter(chkc) end
...
function s.spfilter2(c,e,tp)
	return c:IsFaceup() and c:IsAttribute(ATTRIBUTE_WIND) and not c:IsCode(id) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
