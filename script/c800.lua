--Served of the Sky Prison
local s,id=GetID()
function s.initial_effect(c)
	c:EnableReviveLimit()
	Link.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsSetCard,0x800),1,1)
...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return g and g:IsExists(s.negfilter,1,nil)
end
...
function s.thfilter1(c)
	return c:IsCode(167) and c:IsAbleToHand()
end
