...
function s.spfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x3d1) and c:IsSetCard(0x8)
end
...
function s.subval(e,c)
	return c:IsSetCard(0x3e7) and c:IsAttribute(ATTRIBUTE_WATER) and not c:IsSetCard(0x270F)
end
