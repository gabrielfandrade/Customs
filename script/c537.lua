--Servana, The Dragon Server of Fire
local s,id=GetID()
...
function s.atkval(e,c)
	return Duel.GetMatchingGroupCount(Card.IsAttribute,c:GetControler(),LOCATION_GRAVE,LOCATION_GRAVE,nil,ATTRIBUTE_FIRE)*200
end
